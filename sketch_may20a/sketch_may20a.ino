...
// Wi-Fi Credentials
const char* ssid = "SK_WiFiGIGA79F0";         // 실제 Wi-Fi SSID로 변경
const char* password = "2004044866"; // 실제 Wi-Fi 비밀번호로 변경
...
void handleRoot() {
  ...
  html += "const GEMINI_API_URL = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-04-17:generateContent?key=AIzaSyCK5WE5NxHlCHQGd5agdkl5dZs0KLgFIXM';";
